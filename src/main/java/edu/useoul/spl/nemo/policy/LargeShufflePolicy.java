...
public final class LargeShufflePolicy implements Policy {
  public static final PolicyBuilder BUILDER =
      new PolicyBuilder()
          .registerCompileTimePass(new LargeShuffleRelayReshapingPass())
          .registerCompileTimePass(new LargeShuffleDataFlowPass())
          .registerCompileTimePass(new LargeShuffleDataStorePass())
          .registerCompileTimePass(new LargeShuffleDecoderPass())
          .registerCompileTimePass(new LargeShuffleEncoderPass())
          .registerCompileTimePass(new LargeShufflePartitionerPass())
          .registerCompileTimePass(new LargeShuffleCompressionPass())
          .registerCompileTimePass(new LargeShuffleDecompressionPass())
          .registerCompileTimePass(new LargeShuffleDataPersistencePass())
          .registerCompileTimePass(new LargeShuffleResourceSlotPass())
